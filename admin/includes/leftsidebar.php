                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Advertisment </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="addadvertisment.php">Add Advertisment</a></li>
                                    <li><a href="deleteadvertisment.php">Advertisment List</a></li>
                    ...
                    <div class="help-box">
                        ...
                        <p class=""><span class="text-custom">Email:</span> <br /> company123@mail.com</p>
                    </div>
